...
nohup python -u main.py -nc 20 -data Cifar10 -m cnn -algo FedMGDA -gr 1000 -jr 0.5 -did 4 -go cnn -fr 0 -bt 1 -tid 10001 > outputs/cifar10_fedavg_20.out 2>&1 &
nohup python -u main.py -nc 20 -data Cifar10 -m cnn -algo FedMGDA -gr 1000 -jr 0.25 -did 4 -go cnn -fr 0 -bt 1 -tid 10002 > outputs/cifar10_fedavg_5.out 2>&1 &
