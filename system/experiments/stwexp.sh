...
# nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMoCo -gr 1000 -stw 0.1  -did 6 -go cnn -fr 2000 -bt 0.5 -tid 30011 > outputs/cifar10_fedmoco_10_30011.out 2>&1 &
