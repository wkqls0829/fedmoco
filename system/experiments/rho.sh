#!/bin/bash
nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMGDA -gr 1000 -rh 1  -did 7 -go cnn -fr 2000 -tid 20022 > outputs/cifar10_fedmgda_10_20022.out 2>&1 &
nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMGDA -gr 1000 -rh 0.01  -did 7 -go cnn -fr 2000 -tid 20023 > outputs/cifar10_fedmgda_10_20023.out 2>&1 &
...
nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMoCo -gr 1000 -rh 1  -did 6 -go cnn -fr 2000 -bt 0.5 -tid 30022 > outputs/cifar10_fedmoco_10_30022.out 2>&1 &
