#!/bin/bash
nohup python -u main.py -nc 20 -data Cifar10 -m cnn -algo FedMGDA -gr 1000   -did 7 -go cnn -fr 0 -tid 10000 > outputs/cifar10_fedavg_20_10000.out 2>&1 &

nohup python -u main.py -nc 20 -data Cifar10 -m cnn -algo FedMGDA -gr 1000  -did 6 -go cnn -fr 2000 -bt 1 -tid 20000 > outputs/cifar10_fedmgda_20_20000.out 2>&1 &

nohup python -u main.py -nc 20 -data Cifar10 -m cnn -algo FedMoCo -gr 1000  -did 6 -go cnn -fr 2000 -bt 0.5 -tid 30000 > outputs/cifar10_fedmoco_20_30000.out 2>&1 &
