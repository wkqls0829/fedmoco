...
# nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 0 -go cnn -fr 0 -tid 40203 > outputs/cifar10_fedavg_10_40203.out 2>&1 &
# nohup python -u main.py -nc 10 -data Cifar10 -m cnn -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 1 -go cnn -fr 0 -tid 40204 -dd Cifar10_iid > outputs/cifar10_fedavg_10_40204.out 2>&1 &
nohup python -u main.py -nc 1 -data Cifar10 -m cnn -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 7 -go cnn -fr 0 -tid 40105 -dd Cifar10_central > outputs/cifar10_fedavg_10_40105.out 2>&1 &


# nohup python -u main.py -nc 10 -data Cifar10 -m resnet -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 2  -fr 0 -tid 40213 > outputs/cifar10_fedavg_10_40203.out 2>&1 &
# nohup python -u main.py -nc 10 -data Cifar10 -m resnet -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 3  -fr 0 -tid 40214 -dd Cifar10_iid > outputs/cifar10_fedavg_10_40204.out 2>&1 &
# nohup python -u main.py -nc 1 -data Cifar10 -m resnet -algo FedMGDA -lbs 16 -lr 0.001 -gr 500 -rh 1  -did 3  -fr 0 -tid 40115 -dd Cifar10_central > outputs/cifar10_fedavg_10_40115.out 2>&1 &
